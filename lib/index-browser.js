...
var AbortController$1 = _interopDefault(require('abort-controller'));
...
var fetch$1 = fetchCookie(nodeFetch__default);
...
function HttpPouch(opts, callback) {
  ...
  api.id = adapterFun$$1$$1('id', function (callback) {
    ourFetch(genUrl(host, '')).then(function (response) {
      ...
      var uuid$$2 = (result && result.uuid) ?
          (result.uuid + host.db) : genDBUrl(host, '');
      callback(null, uuid$$2);
    });
  });
